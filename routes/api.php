...
Route::post('dosen/tambah/{dosens}', 'API\DosensController@store');
...
Route::post('Mk/tambah/{mk}', 'API\MkController@store');
...
Route::post('Jam_Kuliah/tambah/{jam_kuliah}', 'API\JamKuliahController@store');
...
Route::post('Ruang/tambah/{ruang}', 'API\RuangController@store');
