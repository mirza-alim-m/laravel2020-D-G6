...
<head>
    ...
    <title>Data Dosen <?php echo $__env->yieldContent("title"); ?></title>
    <link rel="stylesheet" href="<?php echo e(asset('polished/polished.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('polished/iconic/css/open-iconic-
bootstrap.min.css')); ?>">
    <style>
        .grid-highlight {
            padding-top: 1rem;
...
mb-4" type="text" placeholder="Search" aria-label="Search" />
                    <li><a href="#"><span class="oi oi-dashboard"></span>
                            Dashboard</a></li>
                            <li><a href="<?php echo e(route('dosens.index')); ?>"><span class="oi oi-people">
                            </span> Dosen</a></li>
                            <li><a href="<?php echo e(route('mata_kuliah.index')); ?>"><span class="oi oi-book">
                            </span>MK</a></li>
                            <li><a href="<?php echo e(route('ruang.index')); ?>"><span class="oi oi-home">
                            </span> Ruang</a></li>
                            <li><a href="<?php echo e(route('jamkuliah.index')); ?>"><span class="oi oi-clock">
                            </span> Jam Masuk</a></li>
                            <li><a href="<?php echo e(route('ubah.pass')); ?>"><span class="oi oi-people">
                ...
                <div class="row ">
                    <div class="col-md-12 pl-3 pt-2">
                        <div class="pl-3">
                            ...
                            <br/> </div> </div> </div> <?php echo $__env->yieldContent("content"); ?> </div> </div> </div> <script
...
<?php /**PATH C:\Users\HP\Documents\smtr 6\Framework Cloud Computing\laravel2020-D-G6\resources\views/layouts/global.blade.php ENDPATH**/ ?>